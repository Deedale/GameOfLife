...
public class MyInterface extends JFrame {
	...
	ImageIcon logo = new ImageIcon(getClass().getClassLoader().getResource("cowpy.jpg"));
	...
	public MyInterface() {
		...
		contentPane.setBackground(new Color(167, 199, 231));
		setContentPane(contentPane);

		JPanel panelTop = new JPanel();
		contentPane.add(panelTop, BorderLayout.NORTH);
		panelTop.setBackground(new Color(167, 199, 231));

		JPanel panelRight = new JPanel();
		panelRight.setLayout(new GridLayout(10, 1));
		contentPane.add(panelRight, BorderLayout.EAST);
		panelRight.setBackground(new Color(167, 199, 231));
...
//		panelTop.add(btnSpeed);
		...
		randSlider.setBackground(new Color(167, 199, 231));
